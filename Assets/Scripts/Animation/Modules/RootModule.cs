...
namespace AI4Animation {
	public class RootModule : Module {
		...
		[SerializeField] private Precomputable<Quaternion> PrecomputedRotations = null;
		...
		public override void DerivedResetPrecomputation() {
			...
			if (PrecomputedRotations == null || !PrecomputedRotations.CheckValidity(this))
		...
		public Quaternion GetRootRotation(float timestamp, bool mirrored) {
			...
			Quaternion Compute() {
				Debug.Log("Expensive function called.");
