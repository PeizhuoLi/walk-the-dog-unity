...
namespace AI4Animation {
	public abstract class BatchProcessorAsync : EditorWindow {
		...
		[NonSerialized] private bool Canceled = false;
		[NonSerialized] private Task ProcessingTask;
		...
		{
			return Canceled && ProcessingTask is { IsCompleted: false };
		}
		...
		public abstract Task DerivedProcess(Item item);
