...
namespace DeepPhase {
    public class DeepPhasePipeline : AssetPipelineSetup {
        ...
        public override void Inspector() {
            ...
            ChannelType = (CHANNEL_TYPE)EditorGUILayout.EnumPopup("Channel Type", ChannelType);
            if (ChannelType == CHANNEL_TYPE.PhaseManifold)
            {
                DeepPhaseTag = EditorGUILayout.TextField("Deep Phase Tag", DeepPhaseTag);
            }
